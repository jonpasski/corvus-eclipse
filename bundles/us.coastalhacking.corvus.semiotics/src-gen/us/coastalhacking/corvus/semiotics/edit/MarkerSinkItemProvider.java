...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.corvus.semiotics.MarkerSink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MarkerSinkItemProvider 
	 ...
	 * @generated
	 */
	public MarkerSinkItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MarkerSink"));
	}
	...
	public String getText(Object object) {
		String label = ((MarkerSink)object).getKey();
		return label == null || label.length() == 0 ?
			getString("_UI_MarkerSink_type") :
			getString("_UI_MarkerSink_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MarkerSink.class)) {
