...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.corvus.semiotics.Root} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RootItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SemioticsPackage.Literals.ROOT__SEMIOTICS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Root.class)) {
			case SemioticsPackage.ROOT__SEMIOTICS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SemioticsPackage.Literals.ROOT__SEMIOTICS,
				 SemioticsFactory.eINSTANCE.createIWorkspaceRoot()));

		newChildDescriptors.add
			(createChildParameter
				(SemioticsPackage.Literals.ROOT__SEMIOTICS,
				 SemioticsFactory.eINSTANCE.createMarkerEntryPoint()));

		newChildDescriptors.add
			(createChildParameter
				(SemioticsPackage.Literals.ROOT__SEMIOTICS,
				 SemioticsFactory.eINSTANCE.createMarkerSink()));
	}
