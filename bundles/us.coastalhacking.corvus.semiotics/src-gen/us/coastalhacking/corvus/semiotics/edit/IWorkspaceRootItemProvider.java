...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.corvus.semiotics.IWorkspaceRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IWorkspaceRootItemProvider 
	 ...
	 * @generated
	 */
	public IWorkspaceRootItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SemioticsPackage.Literals.IWORKSPACE_ROOT__MEMBERS);
		}
	...
	/**
	 * This returns IWorkspaceRoot.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IWorkspaceRoot"));
	}
	...
	public String getText(Object object) {
		String label = ((IWorkspaceRoot)object).getKey();
		return label == null || label.length() == 0 ?
			getString("_UI_IWorkspaceRoot_type") :
			getString("_UI_IWorkspaceRoot_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IWorkspaceRoot.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SemioticsPackage.Literals.IWORKSPACE_ROOT__MEMBERS,
				 SemioticsFactory.eINSTANCE.createIResource()));
	}
