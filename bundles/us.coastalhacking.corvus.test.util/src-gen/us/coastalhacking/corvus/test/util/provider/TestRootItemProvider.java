...
/**
 * This is the item provider adapter for a {@link us.coastalhacking.corvus.test.util.TestRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TestRootItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UtilPackage.Literals.TEST_ROOT__TEST_IDS);
			childrenFeatures.add(UtilPackage.Literals.TEST_ROOT__TEST_REFERENCES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UtilPackage.Literals.TEST_ROOT__TEST_IDS,
				 UtilFactory.eINSTANCE.createTestIds()));

		newChildDescriptors.add
			(createChildParameter
				(UtilPackage.Literals.TEST_ROOT__TEST_REFERENCES,
				 UtilFactory.eINSTANCE.createTestReference()));
	}
